...
#define GLOBAL_HISTOGRAM_MAX_SIZE (10llu*(2<<29))
...
template <typename ImgType, unsigned int nChannels, typename FeatType, unsigned int FeatDim,
	  unsigned int RDim>
CLRTreeTrainer<ImgType, nChannels, FeatType, FeatDim, RDim>::CLRTreeTrainer(const std::string &featureKernelPath,
										bool useCPU)
{
...
template <typename ImgType, unsigned int nChannels, typename FeatType, unsigned int FeatDim,
	  unsigned int RDim>
void CLRTreeTrainer<ImgType, nChannels, FeatType, FeatDim, RDim>::train(
...
template <typename ImgType, unsigned int nChannels, typename FeatType, unsigned int FeatDim,
	  unsigned int RDim>
CLRTreeTrainer<ImgType, nChannels, FeatType, FeatDim, RDim>::~CLRTreeTrainer()
{}


#include <padenti/cl_rtree_trainer_impl_init.hpp>
#include <padenti/cl_rtree_trainer_impl_traverse_ts.hpp>
#include <padenti/cl_rtree_trainer_impl_learn_best_featthr.hpp>
