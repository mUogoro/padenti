...
#ifndef __CL_REGRESSOR_HPP
#define __CL_REGRESSOR_HPP
...
private:
  ...
  std::vector<cl::Buffer> m_clTreeValuesBuff;
...
public:
  CLRegressor(const std::string &featureKernelPath, bool useCPU=false);
  ~CLRegressor();

  CLRegressor<ImgType, nChannels, FeatType, FeatDim, RDim>&
    operator<<(const RTree<FeatType, FeatDim, RDim>&);
...
#include <padenti/cl_regressor_impl.hpp>

#endif // __CL_REGRESSOR_HPP
